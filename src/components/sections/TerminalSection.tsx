      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative max-w-2xl mx-auto">
            <div className="glass rounded-2xl overflow-hidden shadow-[0_0_80px_-20px_rgba(0,255,136,0.2)]">
              {/* Title bar */}
              <div className="flex items-center gap-2 px-4 py-3 bg-surface-elevated/80 border-b border-border">
