...
const COPY = {
  pt: {
    ...
    title: 'Último vídeo',
    description: 'Um espaço para acompanhar as histórias do @KauaArtx.',
    ...
    unavailableTitle: 'Continue a história no YouTube',
    unavailableDescription:
      'Não foi possível carregar o vídeo mais recente aqui agora. Você pode abrir o canal e acompanhar as publicações por lá.',
  ...
  en: {
    ...
    title: 'Latest video',
    description: 'A place to follow the stories on @KauaArtx.',
    ...
    unavailableTitle: 'Continue the story on YouTube',
    unavailableDescription:
      'The latest video could not be loaded here right now. You can open the channel to see its uploads.',
...
export default function LatestYouTube({
  ...
  return (
    <section id="canal" className="deep-band scroll-mt-24 py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-6">
          ...
          <a href={state.channelUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-border-strong px-5 py-3 text-sm text-accent-bright"><Youtube size={17}/>{copy.channel}<ArrowUpRight size={15}/></a>
        </div>
